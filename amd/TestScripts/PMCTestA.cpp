...
int main(int argc, char* argv[]) {
    ...
    for (t = 0, i = NumThreads-1; t < NumThreads; t++, i--) {
        ...
        if (procthreads < 4) {        
            ...
            else ProcNum[t] = (i % 2) * (procthreads/2) + i / 2 + proc0;
        }
...
//  id    scheme  cpu         countregs eventreg event  mask   name
    ...
    {200, S_AMD2, AMD_ZEN,     0,   5,     0,   0xc2,      0,  "BrRetire" }, // branches retired
    {201, S_AMD2, AMD_ZEN,     0,   5,     0,   0xc4,      0,  "BrTaken"  }, // branches taken retired
    {202, S_AMD2, AMD_ZEN,     0,   5,     0,   0xd1,      0,  "BrCond"   }, // conditional branches retired
    {203, S_AMD2, AMD_ZEN,     0,   5,     0,   0xc5,      0,  "BrMispTak"}, // mispredicted taken branches
    {204, S_AMD2, AMD_ZEN,     0,   5,     0,   0xc3,      0,  "BrMispred"}, // mispredicted branches
    {205, S_AMD2, AMD_ZEN,     0,   5,     0,   0x8a,      0,  "L1BTBHit"}, // L1 BTB Hit
    {206, S_AMD2, AMD_ZEN,     0,   5,     0,   0x8b,      0,  "L2BTBHit"}, // L2 BTB Hit
    {210, S_AMD2, AMD_ZEN,     0,   5,     0,   0xcc,      0,  "BrIndMisp"}, // mispredicted indirect branches
    {211, S_AMD2, AMD_ZEN,     0,   5,     0,   0xc7,      1,  "MispDir"}, // mispredicted due to direction mismatch branches
    {212, S_AMD2, AMD_ZEN,     0,   5,     0,   0xc9,      0,  "NearRet"},
    {213, S_AMD2, AMD_ZEN,     0,   5,     0,   0x91,      0,  "resteers"},
